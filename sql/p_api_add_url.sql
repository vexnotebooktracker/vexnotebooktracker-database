SET ANSI_NULLS ON
GO
CREATE OR ALTER PROCEDURE [dbo].[p_api_add_url]
...
BEGIN
  ...
  */
  ...
  BEGIN TRY
	...
	/* If invalid start date or start date is earlier than today 12AM minus 1 day, set it to current datetime. */
    IF @startDate IS NULL
	   OR @startDate < DATEADD(DAY, -1, CAST(CAST(GETUTCDATE() as DATE) as DATETIME))
